...
export function listOptionsWithCode(idUsuario: number, codigoAcesso: number) {
  ...
  return new Promise<T>(async (resolve) => {
    ...
    try {
      ...
      await api
        .get('/enquete/listOptionsWithCode.php', {
          params: {
            idUsuario: base64.encode(String(idUsuario)),
            codigoAcesso: base64.encode(String(codigoAcesso)),
            token: hashData,
          },

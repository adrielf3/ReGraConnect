...
export function addFeedComent(userId: number | any, idPub: number | any, comentario: string | any, origem: string | any, ) {
  ...
  return new Promise<T>(async (resolve) => {
    ...
    try {
      ...
      params.append('comentarios', base64.encode(String(comentario)));
      params.append('origem', base64.encode(String(origem)));
      params.append('token', hashData);

      await api
        .post('/score/scoreComent.php', params, {
